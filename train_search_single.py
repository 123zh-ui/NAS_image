...
def parse():
    ...
    parser.add_argument('--data', type=str, default='ista_nas_single/data', help='location of the data corpus')
    parser.add_argument('--workers', type=int, default=8, help='number of workers to load dataset')
    parser.add_argument('--tmp_data_dir', type=str, default='ista_nas_single/data', help='temp data dir')
    ...
    parser.add_argument('--num_classes', type=int, default=64, help='num_classes')
...
def main():
    ...
    trainer = Trainer(args)#初始化fullnet的参数
    trainer.train()
